...
=== Set the name of the tracker class

You should manually set the tracker class name to make sure `HistoryTracker` can be found and loaded on demand. You can skip this step if you manually require your history tracker class before using any trackables. If you don't know what I'm talking about, then you should follow the example below.
