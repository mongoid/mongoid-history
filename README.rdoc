...
Now it's good to verify this is done correctly, because nothing will work without this being correctly hooked up. You can check like this in irb:

  # Assuming your history tracker is HistoryTracker
  require 'mongoid'
  require 'mongoid-history'
  require './app/models/history_tracker'
  Mongoid::History.tracker_class # Make sure it is the HistoryTracker class
